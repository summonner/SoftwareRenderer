...
namespace NeHe
{
	...
	GLuint Lesson36::EmptyTexture()											// Create An Empty Texture
	{
	...
	void Lesson36::ReduceToUnit( float vector[3] )								// Reduces A Normal Vector (3 Coordinates)
	{																// To A Unit Normal Vector With A Length Of One.
		float length;												// Holds Unit Length
		// Calculates The Length Of The Vector
		length = (float)sqrtf( (vector[0] * vector[0]) + (vector[1] * vector[1]) + (vector[2] * vector[2]) );
	...
	void Lesson36::calcNormal( float v[3][3], float out[3] )					// Calculates Normal For A Quad Using 3 Points
	{
	...
	void Lesson36::ProcessHelix()												// Draws A Helix
	{
	...
	void Lesson36::ViewOrtho()												// Set Up An Ortho View
	{
	...
	void Lesson36::ViewPerspective()											// Set Up A Perspective View
	{
		glMatrixMode( GL_PROJECTION );								// Select Projection
		glPopMatrix();												// Pop The Matrix
	...
	void Lesson36::RenderToTexture()											// Renders To A Texture
	{
	...
	void Lesson36::DrawBlur( int times, float inc )								// Draw The Blurred Image
	{
	...
	BOOL Lesson36::InitGL( GLvoid )					// Any GL Init Code & User Initialiazation Goes Here
	{
	...
	int Lesson36::CleanGL( GLvoid )										// Any User DeInitialization Goes Here
	{
	...
	int Lesson36::DrawGLScene( GLvoid )												// Draw The Scene
	{
		glClearColor( 0.0f, 0.0f, 0.0f, 0.5 );						// Set The Clear Color To Black
