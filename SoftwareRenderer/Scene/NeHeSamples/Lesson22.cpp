...
#define __ARB_ENABLE false											// Used To Disable ARB Extensions Entirely
...
PFNGLCLIENTACTIVETEXTUREARBPROC	glClientActiveTextureARB= NULL;	
	...
	int Lesson22::LoadGLTextures(){												// Load Bitmaps And Convert To Textures
...
#pragma warning (disable:6386 28182)
...
#pragma warning (default:6386 28182)
		return status;											// Return The Status
	}

	GLvoid Lesson22::ReSizeGLScene(GLsizei width, GLsizei height) {		// Resize And Initialize The GL Window
	...
	int Lesson22::InitGL(GLvoid)										// All Setup For OpenGL Goes Here
	{
	...
	/*	Okay, Here Comes The Important Stuff:
		...
		GL_BUMP:   Copyright Diego T?tara, 1999.			
	...
	*/	
	...
	void Lesson22::doLogo(void) {			// MUST CALL THIS LAST!!!, Billboards The Two Logos.
	...
	bool Lesson22::doMesh1TexelUnits(void) {
