...
Renderer::Mesh GLUquadric::Build( IRenderer& renderer, Renderer::Quadric& quadric, int slices, int stacks, const Vector4& color ) const
{
	...
	return quadric.Build( drawStyle, slices, stacks );
}
